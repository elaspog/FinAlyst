/*
  ...
  <Application.Resources>
      <vm:ViewModelLocator xmlns:vm="clr-namespace:FinAlyst"
                           x:Key="Locator" />
  </Application.Resources>
...
namespace FinAlyst.ViewModels
{
    ...
    public class ViewModelLocator
    {
        ...
        public ViewModelLocator()
        {
            ...
            SimpleIoc.Default.Register<PlansViewModel>();
            SimpleIoc.Default.Register<SummariesViewModel>();
        }
        ...
        public PlansViewModel PlansViewModel
        {
            get
            {
                return ServiceLocator.Current.GetInstance<PlansViewModel>();
            }
        }

        public SummariesViewModel SummariesViewModel
        {
            get
            {
                return ServiceLocator.Current.GetInstance<SummariesViewModel>();
            }
        }
